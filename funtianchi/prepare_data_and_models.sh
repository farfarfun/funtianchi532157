...
cd models
echo "Baichuan2-7B"
funget http://dail-wlcb.oss-cn-wulanchabu.aliyuncs.com/dj-competition/huggingface/Baichuan2-7B-Base.tar.gz --multi
tar zxvf Baichuan2-7B-Base.tar.gz

echo "Falcon-1B"
funget http://dail-wlcb.oss-cn-wulanchabu.aliyuncs.com/dj-competition/huggingface/falcon-rw-1b.tar.gz --multi
